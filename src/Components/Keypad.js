...
export default function Keypad() {
  ...
  <div className="keypad">
    <Empty/>
    <Keys name='W' id='W' onMouseDown={() => setIsWPressed(true)} onMouseUp={() => setIsWPressed(false)}/>
    <Empty/>
    <Keys name='A' id='A' onMouseDown={() => setIsAPressed(true)} onMouseUp={() => setIsAPressed(false)}/>
    <Keys name='S' id='S' onMouseDown={() => setIsSPressed(true)} onMouseUp={() => setIsSPressed(false)}/>
    <Keys name='D' id='D' onMouseDown={() => setIsDPressed(true)} onMouseUp={() => setIsDPressed(false)}/>
  </div>
</div>;
}
